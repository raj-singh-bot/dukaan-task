...
type PaymentsCashfreeDashboardRowframe2282Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "paymenttext" | "howtousetext"
> &
  Partial<{ paymenttext: string; howtousetext: string }>;

const PaymentsCashfreeDashboardRowframe2282: React.FC<
  PaymentsCashfreeDashboardRowframe2282Props
> = (props) => {
  const [frame2282value, setFrame2282value] = React.useState<string>("");
...
PaymentsCashfreeDashboardRowframe2282.defaultProps = {
  paymenttext: "Payments",
  howtousetext: "How it works",
};

export default PaymentsCashfreeDashboardRowframe2282;
