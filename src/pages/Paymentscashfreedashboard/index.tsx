...
const PaymentscashfreedashboardPage: React.FC = () => {
  ...
  const sideBarMenu: SideBarMenuType = [
    ...
    },
    {
      ...
      label: "Payments",
      href: "/paymentscashfreedashboard",
      active: window.location.pathname === "/paymentscashfreedashboard",
    },
    {
      icon: (
        <Img
  ...
  const [inputsearchfielvalue, setInputsearchfielvalue] =
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center justify-start mt-[860px] pb-[15px] w-full">
                ...
                >
                  <div className="block">
                    <Text className="text-[13px] w-auto">
                      Available credits
                    </Text>
                    <Text className="text-[13px] w-auto">222.10</Text>
                  </div>
                </MenuItem>
              </div>
            </Menu>
                  ...
                  <div className="flex flex-col gap-3 items-end justify-start w-full">
                    ...
                    <div className="bg-gray-100 gap-10 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-start max-w-[1128px] px-3 py-2.5 rounded w-full">
                      <div className="flex flex-1 flex-col items-start justify-center w-full">
                        <div className="flex flex-col items-center justify-start w-auto">
                          <TableHeaderText className="flex flex-col gap-4 items-center justify-start w-auto" />
                        </div>
                      </div>
                      <div className="flex flex-1 flex-col items-start justify-center w-full">
                  ...
                  >
                    {data.map((item, i) => {
                      return (
                        <div
                          key={i}
                          className="bg-white-A700 flex flex-1 flex-col h-12 md:h-auto items-center justify-start max-w-[1128px] px-3 py-3.5 w-full"
                        >
